...
function FullViewer({ view='viewer', rightSection=false, rightSectionRef }) {
  ...
  useLayoutEffect(() => {
    if (!rightSection || !isMobile || currentView !== 'projectList') {
      return undefined;
    }
    ...
    if (!coreEl || !contentEl || typeof ResizeObserver === 'undefined') {
      return undefined;
    }
    ...
    observer.observe(coreEl);
    observer.observe(contentEl);

    return () => {
      observer.disconnect();
    };
  }, [currentView, isMobile, rightSection, updatePagination]);
